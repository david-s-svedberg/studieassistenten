...
public class PracticeTestPdfGenerationService : IPracticeTestPdfGenerationService
{
    public PracticeTestPdfGenerationService()
    {
    ...
    void ComposeHeader(IContainer container)
    {
        container.Row(row =>
        {
            ...
            {
                column.Item().Text("Övningsprov").FontSize(20).Bold().FontColor(Colors.Blue.Medium);
