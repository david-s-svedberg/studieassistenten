...
/// <summary>
/// Mock implementation of IAnthropicApiClient for testing.
/// Returns predefined responses instead of calling the real Anthropic API.
/// </summary>
public class MockAnthropicClient : IAnthropicApiClient
{
    private int _callCount = 0;

    public int CallCount => _callCount;

    public Task<MessageResponse> SendMessageAsync(string systemPrompt, string userPrompt, decimal temperature = 0.7m, int? maxTokens = null)
    {
        _callCount++;
        ...
        var response = new MessageResponse
        {
            ...
            {
                new TextContent { Text = responseText }
            },
            Usage = new Usage
            {
